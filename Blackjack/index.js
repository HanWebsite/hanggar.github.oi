...
let money = 500 //Starting player's bank
...
let betBn5 = document.getElementById("betbtn5")
let betBn6 = document.getElementById("betbtn6")
let betBn7 = document.getElementById("betbtn7")
...
betBn5.textContent = "$" + betBtn5 + " BET"
betBn6.textContent = "$" + betBtn6 + " BET"
betBn7.textContent = "$" + betBtn7 + " BET"
...
function noMoney() {
    messageEl.textContent = "Relod Website And You Get $500"
}